...
import { fadeInUpVariants } from "@/animations/utils";

/**
 * Variants para items de problema/solución con stagger
 */
...
/**
 * Componente Value - Sección PAS (Problema-Agitación-Solución)
 * Comunica la propuesta de valor de forma clara y convincente
 */
export default function Value() {
  const shouldReduceMotion = useReducedMotion();

  // Variants adaptados según preferencia de movimiento
  ...
  const agitationItemVariants: Variants = shouldReduceMotion
    ? { hidden: { opacity: 0 }, visible: { opacity: 1 } }
    : {
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            ...
            <motion.div
              className="bg-[#0a3060]/60 backdrop-blur-sm border border-blue-400/20 rounded-2xl shadow-xl shadow-blue-500/10 p-6 sm:p-8 relative z-10"
              ...
              <div className="relative z-10 mb-12">
                ...
                <ul className="space-y-3 relative z-10">
                  <motion.li
                    ...
                    variants={agitationItemVariants}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, margin: "-50px" }}
                    custom={0.5}
