...
async function getCountFlashcardsByTheme(req: NextRequest) {
...
export const GET = rateLimitter({ fn: (req: NextRequest) => getCountFlashcardsByTheme(req), options: RATE_LIMIT_CONFIGS.DASHBOARD });